		...
		<div class="container">
			<div class="dashboard">
				...
				<div class="card p-2 m-3">
					<div class="card-body">
						<a href="Manage.jsp" class="bts"> <i class="fa-solid fa-plus" id="plus"></i> Add Book</a>
					</div>
				...
				<div class="card p-2 m-3">
					...
					<form action="datafetchbook" method="get">
						<button type="submit" class="bts" id="viewbook"><i class="fa-solid fa-book-open-reader" id="bookview"></i>View Books</button>
					</form>
					</div>
				...
				<div class="card p-2 m-3">
					...
					<form action="fetchusers">
						<button type="submit" class="bts" id="viewuser"><i class="fa-solid fa-user"></i> view User</button>
					</form>
					</div>
